...
export default {
    ...
    state: {
        APP_ENV: {
            ...
            STARPORT_APP: VUE_APP_DEV_UI || 'http://localhost:12345',
            FRONTEND: VUE_APP_FRONTEND || '',
            RPC: VUE_APP_API_TENDERMINT || '',
            API: VUE_APP_API_COSMOS || '',
            WS: VUE_APP_WS_TENDERMINT || '',
            ADDR_PREFIX: VUE_APP_ADDRESS_PREFIX || ''
        },
        backend: {
            env: {
                node_js: false,
